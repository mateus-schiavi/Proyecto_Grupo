...
const enlacesContainer = document.getElementById('enlaces');
  ...
  enojonArray.forEach(enlaces => {
    enlacesContainer = document.createElementNS('a');
    enlacesElement.textContent = enlaces.texto;
    enlacesElement.href = enlaces.url;
    enlacesElement.target = '_blank';
    enlacesContainer.appendChild(enlacesElement);
